...
// Get total count
$stmt = $pdo->prepare('SELECT COUNT(*) as count FROM contact_enquiries WHERE trip_type = "hotel"');
$stmt->execute();
...
<html lang="en">
  <head>
    ...
    <title>Hotel Leads | Rudraansh Tours & Travel</title>
        ...
        <section class="panel-card">
          ...
          <?php else: ?>
            <div class="empty-state">
              <p>No hotel leads found in database.</p>
    ...
    <script>
      ...
      function deleteLead(id, name) {
        if (confirm(`Are you sure you want to delete the lead for ${name}? This action cannot be undone.`)) {
          fetch('../backend/delete-hotel-lead.php', {
            method: 'POST',
            headers: {
